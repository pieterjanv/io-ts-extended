...
export default [
	...
	[t.intersection([t.type({}), t.type({ b: t.number })]), t.partial({ a: t.string, b: t.number}), true],
	[t.intersection([t.type({ a: t.string, b: t.unknown }), t.type({ b: t.number, c: t.boolean })]), t.partial({ a: t.string, b: t.number}), true],
	[t.intersection([t.type({ a: t.string, b: t.unknown }), t.partial({ b: t.number, c: t.boolean })]), t.partial({ a: t.string, b: t.number}), true],
	[t.intersection([t.recursion('T', (self) => t.type({ a: t.string, b: self })), t.partial({ b: t.string })]), t.partial({ a: t.string, b: t.string}), true],
	...
	[t.recursion('T', (self) => t.type({ a: t.string, b: t.union([self, t.number]) })), t.partial({ a: t.string, b: t.type({ a: t.string })}), false],
