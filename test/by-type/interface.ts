...
export default [
	...
	[t.exact(t.type({ a: t.string })), t.type({ a: t.string }), true],
	...
	[t.intersection([t.type({ a: t.string }), t.type({ b: t.number })]), (t.type({ a: t.string, b: t.number, c: t.boolean })), false],
	[t.intersection([t.type({ a: t.string }), t.partial({ b: t.number })]), (t.type({ a: t.string })), true],
