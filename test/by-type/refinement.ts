...
export default [
	...
	[myClss, t.brand(t.type({ a: t.string }), (x): x is t.Branded<{ a: string }, Brand> => true, 'Brand'), false],
	...
	[t.fn([['a', t.string]] as const, t.boolean), t.brand(t.fn([['a', t.string]] as const, t.boolean), (x): x is t.Branded<(a: string) => boolean, Brand> => true, 'Brand'), false],
